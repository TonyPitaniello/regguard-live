  ...
  const steps: OnboardingStep[] = [
    {
      ...
      tips: [
        ...
        'Estimator/Permit Runner $79 · Pro $149 · IC Diligence Bundle $1,500',
      ],
    ...
    },
    {
      ...
      tips: [
        ...
        'Upgrade for deep scout research and the IC Diligence Bundle ZIP',
      ],
    ...
    },
    {
      ...
      tips: [
        ...
        'Permit runners: start at Estimator / Permit Runner $79/mo',
      ],
